...
Gem::Specification.new do |spec|
  ...
  spec.description = 'dharma_quotes is a cheerful library of quotes from Buddhist texts. '\
                     'It provides functionality to run methods that return random quotes '\
                     'from the Dharma.'
